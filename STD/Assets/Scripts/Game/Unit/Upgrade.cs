...
public class Upgrade:MonoBehaviour
{
    ...
    //Apply unit upgrade
    public void CopyUnitUpgrades(Upgrade upgr)
    {
        //cycle upgrades, apply active
        for(int i = 0; i < upgr.unitUpgrades.Length; ++i)
        {
            if (upgr.unitUpgrades[i].active)
            {
                DoUnitUpgrade(i);
            }
        }
...
public class RightActions
{
    ...
    public UnityAction checkActive;

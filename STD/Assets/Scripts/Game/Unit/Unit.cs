...
public class Unit : MonoBehaviour {
	...
	protected void InitSupportClasses(){
		...
		move.InitMovement(mainMap,assets,overlord,this,baseStats.speed,baseStats.moveCosts,tileLocation,con);
    ...
    */
    ...
    //Set statuses
    public virtual void SetStatus(bool setFire, bool stat)
    {
        if (setFire)
        {
            currentStats.onFire = stat;
        }
        else
        {
            currentStats.isPoisoned = stat;
        }
    }
...
public class UnitInfo
{
    ...
    //Right Menu
    public RightActions[] Group_01;
    public RightActions[] Group_02;
    public RightActions[] Group_03;
